        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-400 mb-4">
              Upload your resume and we'll extract all your information
              (projects, experience, education, skills, etc.) and add it to your
              shared arsenal.
            </p>
            <div className="">
              <label
              ...
              >
                Select Resume File
                <div className="flex flex-col items-center justify-center gap-2 border group text-gray-400 border-gray-600 border-dashed rounded-md p-4 py-10 my-4 :border-green-500 hover:text-green-400 cursor-pointer transition-colors bg-gray-800/50">
                  {resume ? (
          ...
          >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  >
                    ...
                    {newResumeData.category &&
                      jobCategories[newResumeData.category].map((sub) => (
            ...
            <div className="mt-8">
              <button
                type="submit"
                disabled={
                  !newResumeData.jobDescription ||
                  !newResumeData.category ||
                  !newResumeData.subCategory
                }
